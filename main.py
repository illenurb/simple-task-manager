...
app = FastAPI(title="Gerenciador de Tarefas Simples",
...
async def toggle_complete_task(task_id: int, completed: str = Form(...)):
    update_task_status(task_id, completed.lower() == 'true')
    return RedirectResponse(url="/", status_code=303)
